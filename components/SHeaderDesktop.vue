...
<script>
  ...
  import SNavDesktop from '@/components/SNavDesktop';
  ...
  export default {
    ...
    computed: {
      ...
      _logo() {
        return this.$store.state.settings.logoDesktop && this.$store.state.settings.logoDesktop.filename || false;
      },
